...
ENV SPRING_DATASOURCE_URL=jdbc:postgresql://89.111.155.206:5432/account_db2
...
#ENV SPRING_DATASOURCE_URL=jdbc:postgresql://postgres-docker-container:5432/account_db2